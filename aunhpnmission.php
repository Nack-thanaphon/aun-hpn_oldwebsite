    ...
    <div class=" container-fluid" style="padding:0px;">
        <div class="jumbotron" style="border-radius: 0px;margin-bottom: 0px;">
            <div class="container-fluid" style="width:75%;border-left: 0px solid orange">
                <h1 class="headerText " style="padding-top:px;">Our Mission</h1>
                <h2 class="fontpara2"> ASEAN University Network – Health Promotion Network</h2>
            </div>
        </div>
    </div>
    <div class="container-fluid"
        style="width:75%;padding-bottom: 40px; background-color:white;padding-top: 45px;padding-left:60px;padding-right:70px;">

            <ol style="padding-left:80px;padding-right:30px;" class="text-justify">
                <li class="toptop">To serve as a platform for ASEAN higher education institutions for collaboration among
                    themselves
                    and with other key stakeholders for the purpose of health promotion in the ASEAN region.
                </li>
                <li class="toptop">To share knowledge, skills and resources among the network members in order to build
                    capacity for
                    health promotion and to develop innovative solutions to common health challenges in the
                    region.</li>
            </ol>
            <br><br>
    </div>
