    ...
    <div class=" container-fluid" style="padding:0px;">
        <div class="jumbotron" style="border-radius: 0px;margin-bottom: 0px;">
            <div class="container" style="border-left: 0px solid orange">
                <h1 class="headerText" style="padding-top:px;">The 5th International Advisory Committee  meeting </h1>
                <h2 class="fontpara2">and the 4th Planning and Implementation meeting</h2>
            </div>
        </div>
    </div>
    <div class="container" style="padding:0px;">
        <img style="border:0px solid grey;width:100%;" class="img-fluid" src="../img/act/IACครั้ง5.JPG" alt="" srcset="">
    </div> 
    <div class="container" style="background-color:white;padding:35px 55px;">
        <h4 class="text-justify" style="text-indent:30px;">The 5th International Advisory Committee (IAC) meeting and the 4th Planning and Implementation meeting are scheduled for the day before the conference on 19 August 2019 at University of Philippines, Manila, Philippines</h4>
